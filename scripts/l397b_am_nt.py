...
STEER_VECTOR = "1397"
STRENGTHS = [-0.3, 0.0, 0.2, 0.3]
SCENARIOS = ["blackmail", "murder"]

MODEL = "steered/Qwen/Qwen3.5-397B-A17B"
...
LOG_DIR = "logs/ladder/397b/am-nothink/block01-e25"
...
def steer_args(strength: float) -> dict[str, Any]:
    ...
    """
    return {VECTOR_ARG: STEER_VECTOR, STRENGTH_ARG: strength, "enable_thinking": False}
